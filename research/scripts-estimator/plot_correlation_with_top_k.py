...
quality_data = pd.read_csv('/home/ec2-user/environment/data-estimator/model_results.csv')
...
performance_metrics = [
    'tsn_top1_verb', 'tsn_top5_verb', 'tsn_top1_noun', 'tsn_top5_noun', 'tsn_top1_action', 'tsn_top5_action',
    'avion_top1_verb', 'avion_top5_verb', 'avion_top1_noun', 'avion_top5_noun', 'avion_top1_action', 'avion_top5_action'
]
...
print(merged_data[quality_dimensions + ['avion_top5_action']])
...
label_mapping = {
    ...
    'tsn_top1_verb': 'Top-1 Verb',
    'tsn_top5_verb': 'Top-5 Verb',
    'tsn_top1_noun': 'Top-1 Noun',
    'tsn_top5_noun': 'Top-5 Noun',
    'tsn_top1_action': 'Top-1 Action',
    'tsn_top5_action': 'Top-5 Action',
    'avion_top1_verb': 'Top-1 Verb',
    'avion_top5_verb': 'Top-5 Verb',
    'avion_top1_noun': 'Top-1 Noun',
    'avion_top5_noun': 'Top-5 Noun',
    'avion_top1_action': 'Top-1 Action',
    'avion_top5_action': 'Top-5 Action'
}
...
ax.set_xlabel('Action Recognition Model (Top-k) Performance', fontsize=12)
...
plt.tight_layout()
plt.savefig('/home/ec2-user/environment/figures/spearman_correlation_heatmap.pdf')
...
#         plt.ylabel(metric)
#         plt.grid(True)
#         plt.savefig(f'figures/scatter_{metric}_vs_{dimension}.png')
...
plt.tight_layout()
plt.savefig('/home/ec2-user/environment/figures/quality_score_vs_dimensions_correlation_heatmap.png')
...
plt.tight_layout()
plt.savefig('/home/ec2-user/environment/figures/quality_score_vs_dimensions_boxplots.png')
